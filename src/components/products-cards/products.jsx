  ...
  return (
    <div className="products_cards">
      <div className="first_three_col">
        <div className="second_two_col">
          <NavLink to="/catalogue/meat-bird">
            <div className="product_card meat_card">
          ...
          <div className="product_card milk_card">
            <div className="card_description">
              <div className="card_title">
        ...
        <div className="product_card sea_product">
          <div className="card_description">
            <div className="card_title">
              <h3>Морепродукты</h3>
            </div>
      ...
      <div className="second_col">
        <div className="product_card beer_product">
          <div className="card_description">
            <div className="card_title">
              <h3>Пиво</h3>
            </div>
        ...
        <div className="product_card cold_product">
          <div className="card_description">
            <div className="card_title">
      ...
      <div className="last_col">
        <div className="last_two_col">
          <div className="product_card asal_product">
            <div className="card_description">
              <div className="card_title">
                <h3>Мёд</h3>
              </div>
          ...
          <div className="product_card veget_product">
            <div className="card_description">
              <div className="card_title">
                <h3>Свежие овощи</h3>
              </div>
        ...
        <div className="product_card fruits_product">
          <div className="card_description">
            <div className="card_title">
              <h3>Свежие фрукты</h3>
            </div>
